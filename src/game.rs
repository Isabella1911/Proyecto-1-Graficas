...
/// Punto único de entrada del juego (antes era `fn main`)
    ...
    while !rl.window_should_close() {
        match state {
            GameState::Menu => {
                ...
                d.draw_text("1 - zona 1, 2 - zona 2, 3 - zona 3", 100, 220, 20, Color::LIGHTGRAY);
